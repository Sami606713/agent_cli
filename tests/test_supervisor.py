...
from agentctl.core.health import find_free_port, is_port_free, wait_for_http
from agentctl.core.supervisor import ProcessSpec, StartupFailure, Supervisor
...
class TestPortHelpers:
    ...
    def test_describe_port_holder_never_raises(self):
        from agentctl.core.health import describe_port_holder
